    ...
    def __init__(self, num_objectives=3):
      ...
      #  print(f"initialized priority graph with {self.num_objectives} objectives")
        def specification(simulation):
            ...
            print(f"this is an example for a multi objective {rho}, {type(rho)} ")
...
class distance(specification_monitor):
    def __init__(self):
        def specification(simulation):
            ...
            print(f"this is an example for a single objective {rho} ")
            return rho
...
def run_experiment(path, parallel=False, model=None,
    ...
    print(f"Testing the value of multi {multi}, the number of objectives {num_objectives}")
