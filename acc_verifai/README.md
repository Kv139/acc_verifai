...
1. Locally build the modified version of [VerifAI](https://github.com/BerkeleyLearnVerify/VerifAI) provided in the repository and install [Scenic](https://github.com/BerkeleyLearnVerify/Scenic) version 2.1.0.
